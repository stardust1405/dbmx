...
export function GetAllPostgresTables(arg1:number):Promise<Array<string>>;

export function GetPostgresConnections():Promise<Array<model.PostgresConnection>>;

export function GetPostgresServerDatabases(arg1:number,arg2:number,arg3:string):Promise<Array<model.Database>>;
